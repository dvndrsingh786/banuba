...
Properties {
    ...
    _ReflectAlpha("_ReflectionAlpha", Range(0,1.0)) = 0.5
	_MainColorMultiplier("_MainColorMultiplier", Range(0.,3.0)) = 1.0
...
void surf (Input IN, inout SurfaceOutput o) 
{
	...
	o.Albedo =  reflcol.rgb * _ReflectColor.rgb + c.rgb * _MainColorMultiplier;
	o.Emission = o.Albedo * 0.25;
	o.Alpha = refl2Refr * _ReflectAlpha; 
}
ENDCG
